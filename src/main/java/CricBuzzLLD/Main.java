...
import CricBuzzLLD.Team.Player.Person;
import CricBuzzLLD.Team.Player.PlayerDetails;
import CricBuzzLLD.Team.Player.PlayerType;
...
public class Main {
    public static void main(String[] args) {
        ...
        Match match = new Match(teamA, teamB, new Date(), "Chinnaswamy Stadium", matchType);
        match.startMatch();
    }
